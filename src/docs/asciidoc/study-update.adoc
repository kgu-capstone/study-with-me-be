...
== 스터디 종료
=== 1. Authorization Header에 AccessToken이 없으면 스터디를 종료할 수 없다
HTTP Request
include::{snippets}/StudyApi/Close/Failure/Case1/http-request.adoc[]
include::{snippets}/StudyApi/Close/Failure/Case1/path-parameters.adoc[]

HTTP Response
include::{snippets}/StudyApi/Close/Failure/Case1/response-body.adoc[]

=== 2. 스터디 팀장이 아니라면 스터디를 종료할 수 없다
HTTP Request
include::{snippets}/StudyApi/Close/Failure/Case2/http-request.adoc[]
include::{snippets}/StudyApi/Close/Failure/Case2/request-headers.adoc[]
include::{snippets}/StudyApi/Close/Failure/Case2/path-parameters.adoc[]

HTTP Response
include::{snippets}/StudyApi/Close/Failure/Case2/response-body.adoc[]
