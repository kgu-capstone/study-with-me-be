...
=== 5. 해당 스터디에 대해서 졸업 또는 참여 취소 이력이 존재한다면 다시 참여 신청을 할 수 없다
HTTP Request
include::{snippets}/StudyApi/Participation/Apply/Failure/Case5/http-request.adoc[]
include::{snippets}/StudyApi/Participation/Apply/Failure/Case5/request-headers.adoc[]
include::{snippets}/StudyApi/Participation/Apply/Failure/Case5/path-parameters.adoc[]

HTTP Response
include::{snippets}/StudyApi/Participation/Apply/Failure/Case5/response-body.adoc[]
...
=== 3. 졸업 요건[최소 출석 횟수]를 만족하지 못했다면 졸업을 할 수 없다
HTTP Request
...
=== 5. 스터디 팀장은 졸업이 불가능하고 졸업을 하기 위해서는 팀장 권한을 위임해야 한다
HTTP Request
include::{snippets}/StudyApi/Participation/Graduate/Failure/Case5/http-request.adoc[]
include::{snippets}/StudyApi/Participation/Graduate/Failure/Case5/request-headers.adoc[]
include::{snippets}/StudyApi/Participation/Graduate/Failure/Case5/path-parameters.adoc[]

HTTP Response
include::{snippets}/StudyApi/Participation/Graduate/Failure/Case5/response-body.adoc[]
