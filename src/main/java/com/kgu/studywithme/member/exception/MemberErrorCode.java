...
public enum MemberErrorCode implements ErrorCode {
    ...
    SELF_REVIEW_NOT_ALLOWED(HttpStatus.CONFLICT, "MEMBER_011", "본인에게 리뷰를 남길 수 없습니다."),
    COMMON_STUDY_NOT_FOUND(HttpStatus.CONFLICT, "MEMBER_012", "함께 스터디를 진행한 기록이 없다"),
    REVIEW_NOT_FOUND(HttpStatus.CONFLICT, "MEMBER_013", "사용자에게 남겨진 리뷰를 찾을 수 없습니다."),
    ;
