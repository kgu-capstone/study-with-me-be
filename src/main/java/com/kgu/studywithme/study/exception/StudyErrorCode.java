...
public enum StudyErrorCode implements ErrorCode {
    ...
    ALREADY_WEEK_CREATED(HttpStatus.CONFLICT, "STUDY_013", "이미 해당 주차와 관련된 내용이 등록되었습니다."),
    ...
    ATTENDANCE_NOT_FOUND(HttpStatus.NOT_FOUND, "STUDY_025", "해당 사용자의 출석 정보가 존재하지 않습니다."),
    ;
