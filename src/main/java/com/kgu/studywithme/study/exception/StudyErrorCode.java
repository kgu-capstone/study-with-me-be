...
public enum StudyErrorCode implements ErrorCode {
    ...
    WEEKLY_MUST_BE_SEQUENTIAL(HttpStatus.CONFLICT, "STUDY_036", "각 주차는 순차적으로 생성되어야 하고 이전 주차가 없으면 해당 주차를 생성할 수 없습니다."),
    WEEK_IS_NOT_LATEST(HttpStatus.CONFLICT, "STUDY_037", "가장 최신 주차만 삭제할 수 있습니다."),
    ;
