...
public enum StudyErrorCode implements ErrorCode {
    ...
    STUDY_AREA_IS_BLANK(HttpStatus.BAD_REQUEST, "STUDY_017", "오프라인으로 진행되는 스터디는 진행 지역이 필수입니다."),
    ...
    MEMBER_IS_NOT_HOST(HttpStatus.CONFLICT, "STUDY_021", "해당 스터디의 팀장이 아닙니다."),
    ...
    CAPACITY_CANNOT_BE_LESS_THAN_MEMBERS(HttpStatus.CONFLICT, "STUDY_025", "현재 인원보다 적은 스터디 인원으로 변경할 수 없습니다."),
    ATTENDANCE_NOT_FOUND(HttpStatus.NOT_FOUND, "STUDY_026", "해당 사용자의 출석 정보가 존재하지 않습니다."),
    ;
