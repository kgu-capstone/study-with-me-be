...
class StudyApiControllerTest extends ControllerTest {
    @Nested
    @DisplayName("스터디 생성 API [POST /api]")
    class register {
    ...
    @Nested
    @DisplayName("수정 폼 제공 API [GET /api/{studyId}]")
    class showUpdateForm {
        private static final String BASE_URL = "/api/{studyId}";
    ...
    @Nested
    @DisplayName("정보 수정 API [PUT /api/{studyId}]")
    class update {
        private static final String BASE_URL = "/api/{studyId}";
